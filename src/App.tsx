...
const navItems: NavItem[] = [
  ...
  { icon: Bot, label: 'IA Safir', path: '/admin/ai' },
  ...
  return (
    <>
      ...
      `}>
        <div className={`h-16 flex items-center border-b border-white/5 px-4 ${collapsed ? 'justify-center' : 'justify-between'}`}>
          {!collapsed && (
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-semibold text-white tracking-tight">Safir VTC</span>
            </div>
          )}
          {collapsed && (
            <div className="w-8 h-8 rounded-lg bg-sapphire-600 flex items-center justify-center">
        ...
        {/* Site vitrine link */}
        <div className={`border-t border-white/5 p-2 ${collapsed ? '' : 'px-2'}`}>
          <NavLink
            to="/"
            onClick={closeMobile}
          ...
          <div className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-white truncate">Safir Admin</p>
                <p className="text-xs text-noir-500 truncate">admin@safir-vtc.fr</p>
              </div>
            )}
          </div>
        </div>
