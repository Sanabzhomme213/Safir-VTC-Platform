    ...
    <div className="rounded-xl border border-white/10 bg-noir-900/50 overflow-hidden max-w-4xl">
      ...
      <div className="bg-gradient-to-r from-sapphire-700 to-sapphire-900 px-6 py-8">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-white mb-1">Mon espace Safir VTC</h2>
      ...
      <div className="card">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea rows={3} className="input-field resize-none" defaultValue="Bienvenue sur votre espace client Safir VTC. Gerez vos reservations et consultez vos factures." />
          </div>
          <div>
